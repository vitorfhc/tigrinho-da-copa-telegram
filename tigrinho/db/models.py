...
class Tournament(Base):
    ...
    # Watermark of settled member games at the last partial-placar group post — the bot posts the
    # standings once per newly-finished member game while the bolãozinho is still running (§22.4).
