...
def help_text() -> str:
    ...
    return (
        ...
        "• /bolaozinho_criar — criar um bolãozinho (te pergunto o nome e o valor no privado)\n"
        ...
        "<b>entrada</b> (ex.: R$ 10). Qualquer um cria com <b>/bolaozinho_criar</b> — eu te "
        "pergunto o <b>nome</b> e o <b>valor da entrada</b> no privado (com botões) — e depois "
        "adiciona jogos que ainda não começaram. Quem criou (ou o admin) gerencia o bolãozinho.\n"
